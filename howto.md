...
Permissions
-----------
To use RedstoneChips permissions you must have a permissions plugin on your server. To activate permissions support enter: `/rcprefs usePermissions true`. Protected channels are can be used also when usePermissions is set to false.
...
- `redstonechips.circuit.&lt;circuit-name&gt;` - allows destroying a specific circuit type.
