...
public class ChatFixUtil {
    ...
    // An extra method added by eisental
    public static void sendCSMessage(CommandSender sender, String msg) {
        if (sender instanceof Player)
            ChatFixUtil.sendMessage((Player)sender, msg);
