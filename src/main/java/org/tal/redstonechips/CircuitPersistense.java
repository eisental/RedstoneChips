 ...
 */
public class CircuitPersistense {
    ...
    public static Circuit stringToCircuit(String circuitString, RedstoneChips plugin) throws IllegalArgumentException, InstantiationException, IllegalAccessException {
        ...
        String sInteractions = t.nextToken();
        ...
        ret.interactionBlocks = stringToBlockArray(world, sInteractions);
    ...
    public static String toFileString(Circuit c, RedstoneChips plugin) {
        ...
        String sInteractions = blockArrayToString(c.interactionBlocks);
        ...
        return name + "|" + world + "|" + sActivation + "|" + sInputs + "|" + sOutputs + "|" + sInteractions + "|" +
                sSturcture + "|" + sArgs + "|" + sState;
    }
