...
import org.yaml.snakeyaml.LoaderOptions; // Import LoaderOptions from SnakeYAML
...
public class BitSetConstructor extends Constructor {
	public BitSetConstructor(LoaderOptions loadingConfig) {
        super(loadingConfig); // Use the constructor that accepts LoaderOptions
